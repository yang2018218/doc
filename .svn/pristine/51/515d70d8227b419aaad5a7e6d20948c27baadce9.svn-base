<template>
  <div class="mod-config">
    <div id="doctorSearch">
      ...
      <label class="agent_crux">
        药单ID：
        <el-input placeholder="药单ID" v-model="searchData.specialistNum" style="width:10rem" clearable></el-input>
      </label>
      <label class>
        咨询时间：
        <el-date-picker
...
<script>
  import AddOrUpdate from './diagnosis-add'
  ...
  export default {
    ...
    methods: {
      ...
      remarkContent () {//备注
        ...
        this.$http({
          url: this.$http.adornUrl('/ycyl/ycylassistantspecialistinfo/cusReview'),
          method: 'post',
          data: {
            infoId: this.itemId,
      ...
      Visit (id) {
        this.$http({
          url: this.$http.adornUrl('/ycyl/ycylassistantspecialistinfo/update'),
          method: 'post',
          data: {
            infoId: id,
            reviewStatus: this.reviewStatus
      ...
      searchGoods () {
        ...
        this.$http({
          url: this.$http.adornUrl('/ycyl/ycylassistantspecialistinfo/getSpecialistInfo'),
          method: 'post',
