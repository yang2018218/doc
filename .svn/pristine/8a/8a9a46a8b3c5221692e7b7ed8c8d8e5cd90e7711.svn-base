  ...
  <el-dialog
    ...
    <el-form :model="dataForm"  ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="身份" size="mini" prop="userType">
        ...
        <el-radio v-model="dataForm.userType" :label="3">医助</el-radio>
        <el-radio v-model="dataForm.userType" :label="4">客服</el-radio>
      </el-form-item>
      <!--      <el-form-item label="身份" size="mini" prop="status">-->
        ...
        this.$http({
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                this.dataForm.userType = Number(data.user.userType) ,
