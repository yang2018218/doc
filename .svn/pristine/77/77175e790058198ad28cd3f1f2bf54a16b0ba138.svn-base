...
(function() {
    var resList = {
        ...
        css: [
            ...
            window.SITE_CONFIG.cdnUrl + '/static/ueditor/themes/default/css/ueditor.css',
            window.SITE_CONFIG.cdnUrl + '/static/ueditor/themes/iframe.css'
        ],
        js: [
            ...
            window.SITE_CONFIG.cdnUrl + '/static/ueditor/ueditor.all.min.js',
