    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.schedName) {
            this.$http({
              url: this.$http.adornUrl(`/generator/qrtzcrontriggers/info/${this.dataForm.schedName}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/generator/qrtzcrontriggers/${!this.dataForm.schedName ? 'save' : 'update'}`),
              method: 'post',
