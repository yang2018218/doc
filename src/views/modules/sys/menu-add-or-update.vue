  ...
  width="600px">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="上级菜单" prop="parentName">
        ...
        <el-input v-model="dataForm.parentName" v-popover:menuListPopover :readonly="false" placeholder="点击选择上级菜单" class="menu-list__input">
      ...
      <el-form-item v-if="dataForm.type !== 2" label="排序号" prop="orderNum">
        <el-input-number ss="sss"  v-model="dataForm.orderNum" controls-position="right" :min="0" label="排序号"></el-input-number>
      </el-form-item>
