          ...
          <el-dialog
            ...
            <div>
              <add-chapter v-bind:studyIdMessageID="studyIdMessage" @guanbi="guanbiBtn" @returnGuanbi="returnGuanbiBtn"
                           ref="addOrUpdateNewBianJi" class="ad6d"></add-chapter>
            </div>
          </el-dialog>
        </div>
...
<script>
  ...
  // import styleData from 'https://g.alicdn.com/de/prismplayer/2.8.8/skins/default/aliplayer-min.css'
  export default {
    data () {
      return {
        animals: '',//动物种类
