    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.schedName) {
            this.$http({
              url: this.$http.adornUrl(`/generator/qrtzblobtriggers/info/${this.dataForm.schedName}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/generator/qrtzblobtriggers/${!this.dataForm.schedName ? 'save' : 'update'}`),
              method: 'post',
