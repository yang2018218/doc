  ...
  <div id="app">
    <div>
      ...
      <div>
        <div class="animal">
          分类：
          <el-checkbox-group style="width: 352px" v-model="checkboxGroup1">
            <el-checkbox-button
              :key="index"
              :label="item.dataId"
      ...
      <p style="margin-top: 10px;" @change="agreeChange">
        <span>免责声明：</span>
      ...
      <div style="display: flex;justify-content: center">
        <el-button
          ...
          :disabled="isdisabled"
          @click="getContent"
          style="width: 80px; margin: 16px auto;"
        >发布
        </el-button>
      </div>
    </div>
      ...
      getContent: function () {
        ...
        this.$http({
          ...
          if (data && data.code === 0) {
            alert('上传成功')
            this.$router.push({
              path: '/marketdynamic-marketdynamic'
            })
          }
        })
      },
