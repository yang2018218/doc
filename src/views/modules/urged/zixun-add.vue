  ...
  >
    <div class="contentBox">
      <div class="contentBox_top">
        ...
        <div class="bingzheng"><span>咨询事件</span>&nbsp;：<div><p>{{dataList.incident}}</p></div></div>
        <div class="bingzheng"><span>指导意见</span>&nbsp;：<div><p>{{dataList.opinion}}</p></div></div>
      </div>
  ...
  export default {
    ...
    methods: {
      init (id) {
        ...
        this.orderId = id
        this.$http({//详情
          url: this.$http.adornUrl(`/ycyl/ycylassistantadvisoryinfo/getAdvisoryInfoById`),
          method: 'get',
