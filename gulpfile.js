...
gulp.task('default', ['clean'], function () {
  ...
  gulp.start(['build', 'create:versionCatalog', 'replace:cdnUrl', 'replace:version', 'concat:config'], function () {
    // 清除, 编译 / 处理项目中产生的文件
    del([`${distPath}/static/config`,`${distPath}/static/js`,`${distPath}/static/css`,`${distPath}/static/fonts`,`${distPath}/static/img`,`${distPath}/static/plugins`,`${distPath}/static/styleCssFile`,`${distPath}/static/styleCssFile`,`${distPath}/static/LodopFuncs.js`, `${versionPath}/static/config`])
